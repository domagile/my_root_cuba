...
import { GenealogyProvider, useGenealogy } from './context/GenealogyContext';
...
function AppContent() {
  const { activeTab, setActiveTab, setSelectedPersonId, persons, themePalette, setTreeMode, isUnlocked } = useGenealogy();
