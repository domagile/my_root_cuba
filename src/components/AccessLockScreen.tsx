        ...
        {activeTab === 'login' && (
          <div className="space-y-4">
            ...
            <button
              ...
              className="w-full p-4 rounded-2xl bg-gradient-to-r from-[#B88E3E]/20 to-[#B88E3E]/10 border border-[#B88E3E]/50 hover:border-[#B88E3E] text-left flex items-center justify-between group transition-all cursor-pointer shadow-md"
            >
              <div className="flex items-center gap-3.5">
                <div className="w-10 h-10 rounded-xl bg-white text-slate-800 flex items-center justify-center font-bold shadow-sm shrink-0">
                ...
                <div>
                  <div className="text-xs font-bold text-white flex items-center gap-2">
                    <span>Увійти як Головний Адміністратор</span>
                    <span className="px-2 py-0.5 rounded-full text-[10px] bg-emerald-500/20 text-emerald-300 font-medium border border-emerald-500/30">
                      Власник
                    </span>
                  </div>
              ...
              <ChevronRight className="w-5 h-5 text-[#B88E3E] group-hover:translate-x-1 transition-transform" />
            </button>
            ...
            <div className="relative flex py-1 items-center">
              ...
              <span className="flex-shrink mx-3 text-[10px] uppercase font-bold tracking-widest text-stone-400">
                або введіть схвалену Google-пошту
              </span>
              <div className="flex-grow border-t border-stone-800" />
            </div>
            ...
            >
              <div className="space-y-1.5">
                ...
                <input
                  ...
                  className="w-full px-4 py-2.5 rounded-xl text-sm bg-stone-950/80 border border-stone-700 text-white placeholder-stone-500 focus:outline-none focus:border-[#B88E3E]"
                  required
                />
              </div>
              ...
              >
                <UserCheck className="w-4 h-4" />
                <span>Перевірити у списку та увійти</span>
              </button>
            </form>
          </div>
        )}
